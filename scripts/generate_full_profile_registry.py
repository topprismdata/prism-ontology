...
sources = [
    ...
    {"uri": "prism:source/FieldExecutionAudit", "name": "某饮料业务员实地店内审计", "category": "FieldAudit"},
    {"uri": "prism:source/GeocodingAuditService", "name": "腾讯POI坐标与地址解析质检服务", "category": "DataQualityService"},
    {"uri": "prism:source/BeverageTownshipMaster", "name": "示范下沉乡镇主数据中心", "category": "EnterpriseMasterData"}
]
...
orgs = [
    {"uri": "prism:org/示范饮料集团", "name": "某饮料装瓶集团", "category": "EnterpriseBottler", "role": "ServiceRelationshipSubject"}
]
