...
产出 dist/outlet-insight/0.1.0/ 包含 OWL 本体、SHACL 形状、度量定义、Manifest 与 SHA-256 校验和。
"""
import hashlib
import json
import shutil
...
DIST_DIR = PROJECT_ROOT / "dist" / "outlet-insight" / "0.1.0"
...
cq_md_lines = [
    "# Outlet Insight Profile v0.1.0 Competency Question Verification Report",
